...
<span class="text-uppercase page-subtitle">Students/<a href="<?php echo base_url('index.php/purchases') ?>" >List of Purchases</a><?php if(isset($edit_data)) { ?>/edit <?php } ?></span>
<h3 class="page-title"><?php if(isset($edit_data_info)) { ?>Edit Data for <?php echo $edit_data_info['vendor'] ?> <?php } else{ ?> Skill Based Programs <?php } ?></h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
            ...
            <div class="card card-small h-100">
                ...
                <h6 class="m-0">List of Purchases</h6>
                </div>
                ...
                <div class="form-row">
                        ...
                        <label for="Vendor">Vendor Name</label>
                         <input type="text" name="vendor" class="form-control" <?php if (isset($edit_data_info)){?> value="<?php echo $edit_data_info['vendor']; ?>"<?php } ?> placeholder="Name of event" required="required">
                        </div>
                      ...
                      <div class="form-group col-md-4">
                        <label for="Bill">Bill no.</label>
                         <input type="text" name="bill" class="form-control" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['bill'] ?>" <?php } ?>  placeholder="Name of Coordinator" required="required">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="Description">Description of Item Purchased</label>
                        <input type="text" name="description" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['description'] ?>" <?php } ?> class="form-control" placeholder="Name of Expert / External Organisation" required="required">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="Amount">Amount in Rs</label>
                        <input type="text" name="amount" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['amount'] ?>" <?php } ?> class="form-control" placeholder="Sponsoring Authority" required="required">
                      </div>
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-1">Date</th>
                          <th scope="col" class="border-1">Name of Vendor</th>
                          
                          <th scope="col" class="border-1">bill no</th>
                          <th scope="col" class="border-1">Amount</th>
                          <th scope="col" class="border-1">description</th>
                      ...
                      <tbody>
                      <?php $i=1; foreach($purchases_list as $list){ ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          ...
                          <td>
                          <a href=" <?php echo base_url('uploads/purchases/'); ?><?php echo $list['file'];  ?>"> <img width="40px"src="<?php echo base_url('assets/images/pdf_logo.png'); ?>"/>   </a>
