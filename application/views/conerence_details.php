...
<span class="text-uppercase page-subtitle">Students/<a href="<?php echo base_url('index.php/conerence') ?>" >Conerence Papers</a><?php if(isset($edit_data)) { ?>/edit <?php } ?></span>
<h3 class="page-title">Conerence Papers : <?php echo $view_details_info['title']; ?> </h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <div class="card card-small mb-4">
                  ...
                  <div class="card-body p-0 pb-3 text-center">
                    ...
                    <tr>
                        ...
                        <td>
                        <?php echo $view_details_info['conerence']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <embed src="<?php echo base_url('uploads/conerence/'); ?><?php echo $view_details_info['file'];  ?>" type="application/pdf" width="100%" height="600px" />