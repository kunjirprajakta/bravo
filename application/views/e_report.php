...
<div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Edit Report Here</h2>
            </div>
          </header>
<!-- Breadcrumb-->
          <ul class="breadcrumb">
                    ...
                    <div class="card-body">
                      <table class="table table-striped table-hover">
                        ...
                        <tr>
                          ...
                          <td>
                            <button class="btn btn-primary" onclick="window.location.href='<?php echo base_url(); ?>ViewAuction/editlotsDetails/<?php echo $list['id_m_a']; ?>'">Get CSV</button>
                          </td>
                        </tr>
