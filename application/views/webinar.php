...
<h3 class="page-title"><?php if(isset($edit_data_info)) { ?>Edit Data for <?php echo $edit_data_info['title'] ?> <?php } else{ ?> Webinar <?php } ?></h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
                ...
                <?php if(!isset($edit_data_info)){echo form_open_multipart($add_data); } else { echo form_open_multipart($edit_form);}?>     
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" name="expert_name" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['expert_name'] ?>" <?php } ?> class="form-control" placeholder="Name of Expert / External Organisation" required="required">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="Organization">Organisation of Expert</label>
                        <input type="text" name="organization" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['organization'] ?>" <?php } ?> class="form-control" placeholder="Sponsoring Authority" required="required">
                      </div>
                      <div class="form-group col-md-4">
                        <label for="Faculty">Name of Faculty</label>
                        <input type="text" name="faculty_name" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['faculty'] ?>" <?php } ?> class="form-control" placeholder="Financial Scholarship" required="required">
                      </div>
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-1">Webinar Title</th>
                      ...
                      <tbody>
                      <?php $i=1; foreach($webinar_list as $list){ ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          ...
                          <td>
                          <a href=" <?php echo base_url('uploads/webinar/'); ?><?php echo $list['file'];  ?>"> <img width="40px"src="<?php echo base_url('assets/images/pdf_logo.png'); ?>"/>   </a>
