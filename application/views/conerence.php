...
<span class="text-uppercase page-subtitle">Students/<a href="<?php echo base_url('index.php/conerence') ?>" >Journal Papers</a><?php if(isset($edit_data)) { ?>/edit <?php } ?></span>
               ...
               <?php $add_permissions=explode(',',$permission['add_p']);
                ...
                <?php if(!isset($edit_data_info)){echo form_open_multipart($add_data); } else { echo form_open_multipart($edit_form);}?>     
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        <label for="conerence">Name of conerence</label>
                         <input type="text" name="conerence" class="form-control" <?php if(isset($edit_data_info)){?> value="<?php echo $edit_data_info['journal'] ?>" <?php } ?>  placeholder="Name of Coordinator" required="required">
                      </div>
                      <div class="form-group col-md-4">
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        <tr>
                          ...
                          <th scope="col" class="border-1">Name of Conerence</th>
                      ...
                      <tbody>
                      <?php $i=1; foreach($conerence_list as $list){ ?>
                        <tr>
                          <td><?php echo $i; ?></td>
                          ...
                          <td>
                          <a href=" <?php echo base_url('uploads/conerence/'); ?><?php echo $list['file'];  ?>"> <img width="40px"src="<?php echo base_url('assets/images/pdf_logo.png'); ?>"/>   </a>
