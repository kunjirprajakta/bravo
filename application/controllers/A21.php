...
class A21 extends CI_Controller
{
	...
	function index()
	{
            ...
            $data['add_data_tanmay'] = base_url().'index.php/A21/shahrukh_add';
    ...
    public function shahrukh_add(){
        $amruta=$this->input->post();
        $insert_tanmay=$this->Common_model->insert("a21",$amruta);
        redirect(base_url('index.php/a21'));
    }
